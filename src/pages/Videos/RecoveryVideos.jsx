...
const RecoveryVideos = () => {
    ...
    // Get unique individual muscles from recovery videos
    const muscles = ['All', ...new Set(videos
        .filter(v => v.category === 'Recovery')
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                            ...
                            <button
                                ...
                                className={`px-6 py-2 rounded-full text-sm font-semibold transition-all duration-300 border ${
                                    selectedMuscle === muscle
                                        ? 'bg-[#4da6ff] border-[#4da6ff] text-white shadow-[0_0_15px_rgba(77,166,255,0.4)]'
                                        : 'bg-white/5 border-white/10 text-gray-400 hover:border-[#4da6ff]/50 hover:text-white'
                                }`}
                            >
                                {muscle}
                            </button>
                ...
                {recoveryVideos.length > 0 ? (
                    ...
                    >
                        ...
                        <h3 className="text-xl text-gray-300 font-medium font-sans">No recovery videos found matching your criteria.</h3>
                    </motion.div>
                )}
            </div>
